...
sub stage_zimbra_store_lib($)
{
   my $stage_base_dir = shift;
       ...
       cpy_file("build/dist/javax.mail-1.6.2.jar",                                  "$stage_base_dir/opt/zimbra/jetty_base/common/lib/javax.mail-1.6.2.jar");
       cpy_file("build/dist/javax.mail-api-1.6.2.jar",                              "$stage_base_dir/opt/zimbra/jetty_base/common/lib/javax.mail-api-1.6.2.jar");
