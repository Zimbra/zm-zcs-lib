...
my %PKG_GRAPH = (
   "zimbra-lib-core-service" => {
      summary   => "Zimbra Third Party core libs",
      version   => "1.0.0",
      revision  => 1,
      hard_deps => [],
      soft_deps => [],
   ...
   "zimbra-lib-store-service" => {
      summary   => "Zimbra Third Party store libs",
      version   => "1.0.0",
      revision  => 1,
      hard_deps => [],
      soft_deps => [],
...
sub stage_zimbra_core_lib($)
{
   my $stage_base_dir = shift;
        ...
        cpy_file("build/dist/zimbra-native.jar",            "$stage_base_dir/opt/zimbra/lib/jars/zimbra-native.jar");
        cpy_file("build/dist/zimbracommon.jar",            "$stage_base_dir/opt/zimbra/lib/jars/zimbracommon.jar");
        cpy_file("build/dist/zimbrasoap.jar",            "$stage_base_dir/opt/zimbra/lib/jars/zimbrasoap.jar");
        cpy_file("build/dist/zimbraclient.jar",            "$stage_base_dir/opt/zimbra/lib/jars/zimbraclient.jar");
        cpy_file("build/dist/zimbrastore.jar",            "$stage_base_dir/opt/zimbra/lib/jars/zimbrastore.jar");
...
sub stage_zimbra_store_lib($)
{
   my $stage_base_dir = shift;
       ...
       cpy_file("build/dist/zimbracommon.jar",            "$stage_base_dir/opt/zimbra/jetty_base/common/lib/zimbracommon.jar");
       cpy_file("build/dist/zimbra-native.jar",            "$stage_base_dir/opt/zimbra/jetty_base/common/lib/zimbra-native.jar");
