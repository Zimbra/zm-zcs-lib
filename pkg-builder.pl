...
sub stage_zimbra_store_lib($)
{
   my $stage_base_dir = shift;
       ...
       cpy_file("build/dist/caffeine-2.9.3.jar",                                    "$stage_base_dir/opt/zimbra/lib/ext-common/caffeine-2.9.3.jar");
       ...
       cpy_file("build/dist/owasp-java-html-sanitizer-20190610.5z.jar",             "$stage_base_dir/opt/zimbra/jetty_base/common/lib/owasp-java-html-sanitizer-20190610.5z.jar");
