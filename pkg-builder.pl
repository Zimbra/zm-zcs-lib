...
sub stage_zimbra_core_lib($)
{
   my $stage_base_dir = shift;
        ...
        cpy_file("build/dist/jackson-core-2.18.1.jar",                              "$stage_base_dir/opt/zimbra/lib/jars/jackson-core-2.18.1.jar");
        cpy_file("build/dist/jackson-annotations-2.18.1.jar",                       "$stage_base_dir/opt/zimbra/lib/jars/jackson-annotations-2.18.1.jar");
        cpy_file("build/dist/jackson-databind-2.18.1.jar",                          "$stage_base_dir/opt/zimbra/lib/jars/jackson-databind-2.18.1.jar");
        cpy_file("build/dist/jackson-dataformat-smile-2.18.1.jar",                  "$stage_base_dir/opt/zimbra/lib/jars/jackson-dataformat-smile-2.18.1.jar");
        cpy_file("build/dist/jackson-module-jaxb-annotations-2.18.1.jar",           "$stage_base_dir/opt/zimbra/lib/jars/jackson-module-jaxb-annotations-2.18.1.jar");
...
sub stage_zimbra_store_lib($)
{
   my $stage_base_dir = shift;
       ...
       cpy_file("build/dist/jackson-databind-2.18.1.jar",                           "$stage_base_dir/opt/zimbra/jetty_base/common/lib/jackson-databind-2.18.1.jar");
       cpy_file("build/dist/jackson-core-2.18.1.jar",                               "$stage_base_dir/opt/zimbra/jetty_base/common/lib/jackson-core-2.18.1.jar");
       cpy_file("build/dist/jackson-annotations-2.18.1.jar",                        "$stage_base_dir/opt/zimbra/jetty_base/common/lib/jackson-annotations-2.18.1.jar");
