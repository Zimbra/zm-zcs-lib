...
sub stage_zimbra_core_lib($)
{
   my $stage_base_dir = shift;
        ...
        cpy_file("build/dist/bcprov-jdk15to18-1.78.1.jar",                          "$stage_base_dir/opt/zimbra/lib/jars/bcprov-jdk15to18-1.78.1.jar");
	cpy_file("build/dist/commons-cli-1.2.jar",                                  "$stage_base_dir/opt/zimbra/lib/jars/commons-cli-1.2.jar");
        ...
        cpy_file("build/dist/httpasyncclient-4.1.5.jar",                            "$stage_base_dir/opt/zimbra/lib/jars/httpasyncclient-4.1.5.jar");
        cpy_file("build/dist/httpclient-4.5.14.jar",                                 "$stage_base_dir/opt/zimbra/lib/jars/httpclient-4.5.14.jar");
        cpy_file("build/dist/httpcore-4.4.16.jar",                                  "$stage_base_dir/opt/zimbra/lib/jars/httpcore-4.4.16.jar");
        cpy_file("build/dist/httpcore-nio-4.4.16.jar",                              "$stage_base_dir/opt/zimbra/lib/jars/httpcore-nio-4.4.16.jar");
        cpy_file("build/dist/httpmime-4.5.14.jar",                                   "$stage_base_dir/opt/zimbra/lib/jars/httpmime-4.5.14.jar");
        ...
        cpy_file("build/dist/antisamy-1.5.8z4.jar",                                  "$stage_base_dir/opt/zimbra/lib/jars/antisamy-1.5.8z4.jar");
        ...
        cpy_file("build/dist/apache-jsp-9.4.57.v20241219.jar",                      "$stage_base_dir/opt/zimbra/lib/jars/apache-jsp-9.4.57.v20241219.jar");
...
sub stage_zimbra_store_lib($)
{
   my $stage_base_dir = shift;
       ...
       cpy_file("build/dist/bcprov-jdk15to18-1.78.1.jar",                           "$stage_base_dir/opt/zimbra/jetty_base/common/lib/bcprov-jdk15to18-1.78.1.jar");
       ...
       cpy_file("build/dist/httpasyncclient-4.1.5.jar",                             "$stage_base_dir/opt/zimbra/jetty_base/common/lib/httpasyncclient-4.1.5.jar");
       cpy_file("build/dist/httpclient-4.5.14.jar",                                  "$stage_base_dir/opt/zimbra/jetty_base/common/lib/httpclient-4.5.14.jar");
       cpy_file("build/dist/httpcore-4.4.16.jar",                                   "$stage_base_dir/opt/zimbra/jetty_base/common/lib/httpcore-4.4.16.jar");
       cpy_file("build/dist/httpcore-nio-4.4.16.jar",                               "$stage_base_dir/opt/zimbra/jetty_base/common/lib/httpcore-nio-4.4.16.jar");
       cpy_file("build/dist/httpmime-4.5.14.jar",                                    "$stage_base_dir/opt/zimbra/jetty_base/common/lib/httpmime-4.5.14.jar");
       ...
       cpy_file("build/dist/owasp-java-html-sanitizer-20190610.7z.jar",             "$stage_base_dir/opt/zimbra/jetty_base/common/lib/owasp-java-html-sanitizer-20190610.7z.jar");
       ...
       cpy_file("build/dist/antisamy-1.5.8z4.jar",                                   "$stage_base_dir/opt/zimbra/jetty_base/webapps/service/WEB-INF/lib/antisamy-1.5.8z4.jar");
